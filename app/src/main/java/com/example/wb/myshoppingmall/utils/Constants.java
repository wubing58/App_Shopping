...
public class Constants {
    //自己电脑ip地址
    public static final String BASE = "http://192.168.1.3:8080/";

    // 数据的基本路径
    public static String BASE_URL_JSON = BASE+"atguigu/json/";

    //图片的基本路径
    public static String BASE_URL_IMAGE = BASE +"atguigu/img/";
